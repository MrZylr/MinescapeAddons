package com.zylr.minescapeaddons.addons.item.armor.robes.pink;
...
public class PinkSkirtItem  extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "pink_skirt");

    public PinkSkirtItem(ArmorItem.Type pType) {
