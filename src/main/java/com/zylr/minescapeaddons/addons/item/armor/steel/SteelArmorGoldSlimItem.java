...
public class SteelArmorGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "steel_armor_g");

    public SteelArmorGoldSlimItem(ArmorItem.Type pType) {
