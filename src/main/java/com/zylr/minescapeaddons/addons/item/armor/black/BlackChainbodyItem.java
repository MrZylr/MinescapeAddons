...
public class BlackChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_chainbody");

    public BlackChainbodyItem(ArmorItem.Type pType) {
