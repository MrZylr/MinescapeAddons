...
public class MonksRobeSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "monks_robes");

    public MonksRobeSlimItem(ArmorItem.Type pType) {
