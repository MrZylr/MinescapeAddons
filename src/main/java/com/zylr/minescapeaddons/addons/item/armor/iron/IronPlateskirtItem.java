...
public class IronPlateskirtItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "iron_plateskirt_armor");

    public IronPlateskirtItem(ArmorItem.Type pType) {
