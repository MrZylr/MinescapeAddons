...
public class AdamantChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "adamant_chainbody");

    public AdamantChainbodyItem(ArmorItem.Type pType) {
