...
public class BlackPlateskirtItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_plateskirt_armor");

    public BlackPlateskirtItem(ArmorItem.Type pType) {
