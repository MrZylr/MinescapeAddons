...
public class BlueWizardRobesGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "blue_wizard_robes_g");

    public BlueWizardRobesGoldSlimItem(ArmorItem.Type pType) {
