...
public class DharoksArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "dharoksarmor");

    public DharoksArmorSlimItem(Type pType) {
