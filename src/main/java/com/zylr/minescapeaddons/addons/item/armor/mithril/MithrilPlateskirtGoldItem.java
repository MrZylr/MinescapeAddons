...
public class MithrilPlateskirtGoldItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "mithril_plateskirt_armor_g");

    public MithrilPlateskirtGoldItem(ArmorItem.Type pType) {
