...
public class MithrilChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "mithril_chainbody");

    public MithrilChainbodyItem(ArmorItem.Type pType) {
