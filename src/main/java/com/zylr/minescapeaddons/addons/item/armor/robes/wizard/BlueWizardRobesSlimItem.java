...
public class BlueWizardRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "blue_wizard_robes");

    public BlueWizardRobesSlimItem(ArmorItem.Type pType) {
