package com.zylr.minescapeaddons.addons.item.armor.white;
...
public class WhiteChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "white_chainbody");

    public WhiteChainbodyItem(ArmorItem.Type pType) {
