...
public class IronArmorTrimSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "iron_armor_t");

    public IronArmorTrimSlimItem(ArmorItem.Type pType) {
