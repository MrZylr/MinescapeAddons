package com.zylr.minescapeaddons.addons.item.armor.robes.grey;
...
public class GreyRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "grey_robes");

    public GreyRobesSlimItem(ArmorItem.Type pType) {
