package com.zylr.minescapeaddons.addons.item.armor.dhide.blue;
...
public class BlueDhideArmorItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "blue_dhide_armor");

    public BlueDhideArmorItem(ArmorItem.Type pType) {
