...
public class AhrimsArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "ahrimsarmor");

    public AhrimsArmorSlimItem(Type pType) {
