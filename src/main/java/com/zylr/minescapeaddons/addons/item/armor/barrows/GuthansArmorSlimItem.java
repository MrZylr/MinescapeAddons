package com.zylr.minescapeaddons.addons.item.armor.barrows;
...
public class GuthansArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "barrowsguthansarmor");

    public GuthansArmorSlimItem(ArmorItem.Type pType) {
