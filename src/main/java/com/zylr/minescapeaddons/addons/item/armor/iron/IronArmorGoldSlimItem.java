...
public class IronArmorGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "iron_armor_g");

    public IronArmorGoldSlimItem(ArmorItem.Type pType) {
