...
public class BronzeArmorTrimSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "bronze_armor_t");

    public BronzeArmorTrimSlimItem(ArmorItem.Type pType) {
