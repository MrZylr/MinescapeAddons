...
public class IronChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "iron_chainbody");

    public IronChainbodyItem(ArmorItem.Type pType) {
