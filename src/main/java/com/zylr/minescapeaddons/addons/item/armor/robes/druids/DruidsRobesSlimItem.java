package com.zylr.minescapeaddons.addons.item.armor.robes.druids;
...
public class DruidsRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "druids_robes");

    public DruidsRobesSlimItem(ArmorItem.Type pType) {
