...
public class RunePlateskirtItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "rune_plateskirt_armor");

    public RunePlateskirtItem(ArmorItem.Type pType) {
