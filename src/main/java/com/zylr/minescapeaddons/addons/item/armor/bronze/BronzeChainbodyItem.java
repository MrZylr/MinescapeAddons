...
public class BronzeChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "bronze_chainbody");

    public BronzeChainbodyItem(ArmorItem.Type pType) {
