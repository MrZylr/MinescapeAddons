...
public class RuneArmorTrimSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "rune_armor_t");

    public RuneArmorTrimSlimItem(ArmorItem.Type pType) {
