...
public class SteelPlateskirtItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "steel_plateskirt_armor");

    public SteelPlateskirtItem(ArmorItem.Type pType) {
