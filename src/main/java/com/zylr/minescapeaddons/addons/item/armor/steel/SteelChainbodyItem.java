...
public class SteelChainbodyItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "steel_chainbody");

    public SteelChainbodyItem(ArmorItem.Type pType) {
