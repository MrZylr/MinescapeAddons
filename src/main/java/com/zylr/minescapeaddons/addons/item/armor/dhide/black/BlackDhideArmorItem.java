package com.zylr.minescapeaddons.addons.item.armor.dhide.black;
...
public class BlackDhideArmorItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_dhide_armor");

    public BlackDhideArmorItem(ArmorItem.Type pType) {
