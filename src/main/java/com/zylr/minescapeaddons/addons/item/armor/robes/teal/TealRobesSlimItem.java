package com.zylr.minescapeaddons.addons.item.armor.robes.teal;
...
public class TealRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "teal_robes");

    public TealRobesSlimItem(ArmorItem.Type pType) {
