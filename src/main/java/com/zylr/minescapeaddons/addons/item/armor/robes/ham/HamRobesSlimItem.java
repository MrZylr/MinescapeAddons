package com.zylr.minescapeaddons.addons.item.armor.robes.ham;
...
public class HamRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "ham_robes");

    public HamRobesSlimItem(ArmorItem.Type pType) {
