...
public class MonksRobeTrimSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "monks_robes_t");

    public MonksRobeTrimSlimItem(ArmorItem.Type pType) {
