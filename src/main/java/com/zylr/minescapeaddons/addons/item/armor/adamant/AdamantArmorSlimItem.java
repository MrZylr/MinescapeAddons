...
public class AdamantArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "adamant_armor");

    public AdamantArmorSlimItem(ArmorItem.Type pType) {
