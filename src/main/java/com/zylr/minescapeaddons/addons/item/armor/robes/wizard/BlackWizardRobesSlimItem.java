...
public class BlackWizardRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_wizard_robes");

    public BlackWizardRobesSlimItem(ArmorItem.Type pType) {
