...
public class RuneArmorGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "rune_armor_g");

    public RuneArmorGoldSlimItem(ArmorItem.Type pType) {
