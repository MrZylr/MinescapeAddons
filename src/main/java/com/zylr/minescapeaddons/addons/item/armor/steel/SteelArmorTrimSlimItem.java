...
public class SteelArmorTrimSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "steel_armor_t");

    public SteelArmorTrimSlimItem(ArmorItem.Type pType) {
