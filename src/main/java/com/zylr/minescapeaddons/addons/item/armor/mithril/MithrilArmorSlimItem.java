...
public class MithrilArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "mithril_armor");

    public MithrilArmorSlimItem(ArmorItem.Type pType) {
