...
public class BronzeArmorGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "bronze_armor_g");

    public BronzeArmorGoldSlimItem(ArmorItem.Type pType) {
