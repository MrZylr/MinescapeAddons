...
public class BronzePlateskirtGoldItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "bronze_plateskirt_armor_g");

    public BronzePlateskirtGoldItem(ArmorItem.Type pType) {
