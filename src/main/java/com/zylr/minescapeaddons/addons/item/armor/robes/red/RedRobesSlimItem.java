package com.zylr.minescapeaddons.addons.item.armor.robes.red;
...
public class RedRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "red_robes");

    public RedRobesSlimItem(ArmorItem.Type pType) {
