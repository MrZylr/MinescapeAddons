...
public class AdamantPlateskirtTrimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "adamant_plateskirt_armor_t");

    public AdamantPlateskirtTrimItem(ArmorItem.Type pType) {
