...
public class RuneArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "rune_armor");

    public RuneArmorSlimItem(ArmorItem.Type pType) {
