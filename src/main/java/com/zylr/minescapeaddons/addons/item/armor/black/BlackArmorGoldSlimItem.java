...
public class BlackArmorGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_armor_g");

    public BlackArmorGoldSlimItem(ArmorItem.Type pType) {
