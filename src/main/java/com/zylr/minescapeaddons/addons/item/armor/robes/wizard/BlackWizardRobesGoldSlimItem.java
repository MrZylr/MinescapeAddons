...
public class BlackWizardRobesGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_wizard_robes_g");

    public BlackWizardRobesGoldSlimItem(ArmorItem.Type pType) {
