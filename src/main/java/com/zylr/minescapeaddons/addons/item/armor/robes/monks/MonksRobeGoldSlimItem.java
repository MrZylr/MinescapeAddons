...
public class MonksRobeGoldSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "monks_robes_g");

    public MonksRobeGoldSlimItem(ArmorItem.Type pType) {
