...
public class ToragsArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "toragsarmor");

    public ToragsArmorSlimItem(ArmorItem.Type pType) {
