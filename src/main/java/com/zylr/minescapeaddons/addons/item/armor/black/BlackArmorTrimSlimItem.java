...
public class BlackArmorTrimSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_armor_t");

    public BlackArmorTrimSlimItem(ArmorItem.Type pType) {
