...
public class SteelPlateskirtGoldItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "steel_plateskirt_armor_g");

    public SteelPlateskirtGoldItem(ArmorItem.Type pType) {
