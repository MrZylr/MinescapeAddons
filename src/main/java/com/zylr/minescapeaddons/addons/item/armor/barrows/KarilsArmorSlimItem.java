...
public class KarilsArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "karils_armor");

    public KarilsArmorSlimItem(ArmorItem.Type pType) {
