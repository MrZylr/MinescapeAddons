package com.zylr.minescapeaddons.addons.item.armor.dhide.green;
...
public class GreenDhideArmorItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "green_dhide_armor");

    public GreenDhideArmorItem(ArmorItem.Type pType) {
