package com.zylr.minescapeaddons.addons.item.armor.robes.purple;
...
public class PurpleRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "purple_robes");

    public PurpleRobesSlimItem(ArmorItem.Type pType) {
