...
public class IronArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "iron_armor");

    public IronArmorSlimItem(ArmorItem.Type pType) {
