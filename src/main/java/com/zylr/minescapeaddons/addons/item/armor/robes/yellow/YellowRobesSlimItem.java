package com.zylr.minescapeaddons.addons.item.armor.robes.yellow;
...
public class YellowRobesSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "yellow_robes");

    public YellowRobesSlimItem(ArmorItem.Type pType) {
