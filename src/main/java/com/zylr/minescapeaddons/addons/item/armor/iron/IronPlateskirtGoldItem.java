...
public class IronPlateskirtGoldItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "iron_plateskirt_armor_g");

    public IronPlateskirtGoldItem(ArmorItem.Type pType) {
