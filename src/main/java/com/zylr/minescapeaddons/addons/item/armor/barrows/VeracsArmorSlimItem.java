...
public class VeracsArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "veracsarmor");

    public VeracsArmorSlimItem(ArmorItem.Type pType) {
