...
public class BlackArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "black_armor");

    public BlackArmorSlimItem(ArmorItem.Type pType) {
