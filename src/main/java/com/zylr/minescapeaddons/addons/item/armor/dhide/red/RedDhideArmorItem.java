package com.zylr.minescapeaddons.addons.item.armor.dhide.red;
...
public class RedDhideArmorItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "red_dhide_armor");

    public RedDhideArmorItem(ArmorItem.Type pType) {
