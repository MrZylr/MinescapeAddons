...
public class BronzePlateskirtItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "bronze_plateskirt_armor");

    public BronzePlateskirtItem(ArmorItem.Type pType) {
