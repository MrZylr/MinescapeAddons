...
public class SteelPlateskirtTrimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "steel_plateskirt_armor_t");

    public SteelPlateskirtTrimItem(ArmorItem.Type pType) {
