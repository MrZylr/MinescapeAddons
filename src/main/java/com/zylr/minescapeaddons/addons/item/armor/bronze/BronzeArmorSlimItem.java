...
public class BronzeArmorSlimItem extends AbstractArmorItem {
    private static final ResourceLocation TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddons.MOD_ID, "bronze_armor");

    public BronzeArmorSlimItem(ArmorItem.Type pType) {
