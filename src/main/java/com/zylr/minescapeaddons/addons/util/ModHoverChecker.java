 ...
 * @author bspkrs
 */
public class ModHoverChecker
{
    private int       top, bottom, left, right, threshold;
    private Widget    widget;
    private long      hoverStart;

    public ModHoverChecker(int top, int bottom, int left, int right, int threshold)
    {
        this.top = top;
        this.bottom = bottom;
        this.left = left;
    ...
    public ModHoverChecker(Widget widget, int threshold)
    {
        this.widget = widget;
        this.threshold = threshold;
    }
