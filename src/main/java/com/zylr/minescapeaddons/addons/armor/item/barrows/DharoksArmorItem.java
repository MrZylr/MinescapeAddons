...
public class DharoksArmorItem extends ArmorItem {
    public DharoksArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties builder) {
    ...
    public <A extends BipedModel<?>> A getArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlotType slotType, A _default) {
        return Main.PROXY.getDharoksArmorModel(slotType);
    }
}
