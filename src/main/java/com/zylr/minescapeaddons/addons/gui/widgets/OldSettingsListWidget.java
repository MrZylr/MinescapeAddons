...
public class OldSettingsListWidget extends ExtendedList<OldSettingsListWidget.SettingsEntry> {
    private Minecraft mc;
    MainSettings parent;

    public OldSettingsListWidget(MainSettings parent, int settingsWidth, int settingsHeight, int topIn, int bottomIn) {
