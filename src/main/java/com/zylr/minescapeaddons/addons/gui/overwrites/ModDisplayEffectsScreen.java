...
@OnlyIn(Dist.CLIENT)
public abstract class ModDisplayEffectsScreen<T extends Container> extends ModContainerScreen<T> {
    /** True if there is some potion effect to display */
    protected boolean hasActivePotionEffects;

    public ModDisplayEffectsScreen(T screenContainer, PlayerInventory inv, ITextComponent titleIn) {
