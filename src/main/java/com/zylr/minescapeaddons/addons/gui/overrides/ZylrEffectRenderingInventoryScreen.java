...
public abstract class ZylrEffectRenderingInventoryScreen<T extends AbstractContainerMenu> extends ZylrAbstractContainerScreen<T> {
    /** MODIFIED EffectRenderingInventoryScreen CODE */
    ...
    public ZylrEffectRenderingInventoryScreen(T menu, Inventory playerInventory, Component title, String initial) {
        super(menu, playerInventory, title, initial);
    }
