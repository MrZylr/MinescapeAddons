...
public class AdamantArmorGoldSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "adamant_armor_g");

    public AdamantArmorGoldSlimItem(ArmorType pType) {
