...
public class AdamantArmorTrimSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "adamant_armor_t");

    public AdamantArmorTrimSlimItem(ArmorType pType) {
