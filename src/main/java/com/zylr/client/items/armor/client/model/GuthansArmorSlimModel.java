...
public class GuthansArmorSlimModel extends ArmorModel {

	public GuthansArmorSlimModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(34, 1).addBox(-2.0F, 2.75F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(1.0F))
		.texOffs(0, 53).addBox(-4.0F, 2.75F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 53).addBox(-4.0F, 4.75F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(34, 1).mirror().addBox(0.0F, 2.75F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(1.0F)).mirror(false)
		.texOffs(0, 53).mirror().addBox(3.0F, 2.75F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 53).mirror().addBox(3.0F, 4.75F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));
