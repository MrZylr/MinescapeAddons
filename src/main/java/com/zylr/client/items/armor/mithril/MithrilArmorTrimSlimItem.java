...
public class MithrilArmorTrimSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "mithril_armor_t");

    public MithrilArmorTrimSlimItem(ArmorType pType) {
