...
public class SnakskinSlimModel extends ArmorModel {

	public SnakskinSlimModel(ModelPart root) {
		super(root);
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(25, 54).addBox(-2.5F, -3.0F, -3.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(1, 54).addBox(-2.5F, 3.0F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(24, 54).addBox(-0.5F, -3.0F, -3.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 2.0F, 0.0F));
