...
public class AdamantChainbodyItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "adamant_chainbody");

    public AdamantChainbodyItem(ArmorType pType) {
