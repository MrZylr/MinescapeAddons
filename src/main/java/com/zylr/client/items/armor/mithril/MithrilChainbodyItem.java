...
public class MithrilChainbodyItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "mithril_chainbody");

    public MithrilChainbodyItem(ArmorType pType) {
