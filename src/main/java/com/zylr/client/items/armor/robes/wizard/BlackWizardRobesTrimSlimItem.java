...
public class BlackWizardRobesTrimSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "black_wizard_robes_t");

    public BlackWizardRobesTrimSlimItem(ArmorType pType) {
