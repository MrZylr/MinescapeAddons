...
public class BlackWizardRobesGoldSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "black_wizard_robes_g");

    public BlackWizardRobesGoldSlimItem(ArmorType pType) {
