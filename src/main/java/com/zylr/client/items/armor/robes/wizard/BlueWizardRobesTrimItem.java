...
public class BlueWizardRobesTrimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "blue_wizard_robes_t");

    public BlueWizardRobesTrimItem(ArmorType pType) {
