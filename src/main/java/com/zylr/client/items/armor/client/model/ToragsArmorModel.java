...
public class ToragsArmorModel extends ArmorModel {

	public ToragsArmorModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r11 = left_arm.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(52, 57).addBox(-0.0312F, -0.7783F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.2094F, -2.7592F, 0.0F, 0.0F, 0.0F, 1.1345F));

		PartDefinition cube_r12 = left_arm.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(52, 57).addBox(-0.6658F, -0.8036F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1123F, -2.7496F, 0.0F, 0.0F, 0.0F, 0.7418F));

		PartDefinition cube_r13 = left_arm.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(52, 57).addBox(-0.0734F, -0.3098F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1123F, -2.7496F, 0.0F, 0.0F, 0.0F, 1.9199F));

		PartDefinition cube_r14 = left_arm.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(52, 57).addBox(-0.1572F, -0.811F, -0.5376F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(52, 57).addBox(-0.1572F, -0.411F, -0.5376F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1123F, -2.7496F, 0.0F, 0.0F, 0.2618F, 1.5272F));

		PartDefinition cube_r15 = left_arm.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(52, 57).addBox(-0.1572F, -0.811F, -0.4624F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1123F, -2.7496F, 0.0F, 0.0F, -0.2618F, 1.5272F));

		PartDefinition cube_r16 = left_arm.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(52, 57).addBox(-0.1521F, -0.3135F, -0.4638F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.2094F, -2.7592F, 0.0F, 0.0F, -0.2618F, 1.5272F));
