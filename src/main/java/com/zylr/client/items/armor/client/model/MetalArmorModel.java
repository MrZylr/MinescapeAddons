...
public class MetalArmorModel extends ArmorModel {

	public MetalArmorModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(21, 57).mirror().addBox(-4.0F, 3.0F, 3.0F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		.texOffs(21, 57).addBox(-2.0F, 3.0F, 3.0F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 2.0F, 0.0F));
		...
		.texOffs(40, 59).mirror().addBox(-1.0F, 3.0F, -3.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.9F, 12.0F, 0.0F));
		...
		.texOffs(40, 59).addBox(-1.0F, 3.0F, -3.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
