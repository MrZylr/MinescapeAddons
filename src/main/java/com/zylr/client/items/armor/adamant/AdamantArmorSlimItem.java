...
public class AdamantArmorSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "adamant_armor");

    public AdamantArmorSlimItem(ArmorType pType) {
