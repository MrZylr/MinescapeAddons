...
public class BlueWizardRobesGoldSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "blue_wizard_robes_g");

    public BlueWizardRobesGoldSlimItem(ArmorType pType) {
