...
public class IronPlateskirtTrimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "iron_plateskirt_armor_t");

    public IronPlateskirtTrimItem(ArmorType pType) {
