package com.zylr.client.items.armor.client.model;// Made with Blockbench 5.0.4
...
public class MysticRobesModel extends ArmorModel {

	public MysticRobesModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(0, 59).addBox(-2.4F, -1.25F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(1.0F))
		.texOffs(41, 46).addBox(0.6F, 1.75F, -2.5F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(42, 50).addBox(-3.4F, 5.6892F, -3.1946F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(42, 50).addBox(-3.4F, 5.6892F, 2.1946F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition cube_r51 = right_arm.addOrReplaceChild("cube_r51", CubeListBuilder.create().texOffs(42, 46).addBox(0.0F, 2.0F, -3.0F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0946F, 3.6892F, -0.5F, -3.1416F, 0.0F, -3.1416F));
		...
		PartDefinition cube_r53 = right_arm.addOrReplaceChild("cube_r53", CubeListBuilder.create().texOffs(42, 50).addBox(-3.15F, -2.0F, 0.0F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, 3.8933F, 1.8625F, 0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r54 = right_arm.addOrReplaceChild("cube_r54", CubeListBuilder.create().texOffs(42, 46).addBox(0.0F, -2.0F, -3.0F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.7625F, 3.8933F, -0.5F, -3.1416F, 0.0F, -2.9671F));

		PartDefinition cube_r55 = right_arm.addOrReplaceChild("cube_r55", CubeListBuilder.create().texOffs(42, 50).addBox(-3.15F, -2.0F, -1.0F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, 3.8933F, -1.8625F, -0.1745F, 0.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(1, 59).mirror().addBox(-0.6F, -1.25F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(1.0F)).mirror(false)
		.texOffs(42, 50).mirror().addBox(-1.6F, 5.6892F, 2.1946F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(42, 50).mirror().addBox(-1.6F, 5.6892F, -3.1946F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r56 = left_arm.addOrReplaceChild("cube_r56", CubeListBuilder.create().texOffs(42, 46).mirror().addBox(-1.0F, 2.0F, -3.0F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0946F, 3.6892F, -0.5F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition cube_r57 = left_arm.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(42, 50).mirror().addBox(-1.85F, -2.0F, -1.0F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.25F, 3.8933F, -1.8625F, -0.1745F, 0.0F, 0.0F));

		PartDefinition cube_r58 = left_arm.addOrReplaceChild("cube_r58", CubeListBuilder.create().texOffs(42, 46).mirror().addBox(-1.0F, -2.0F, -3.0F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.7625F, 3.8933F, -0.5F, -3.1416F, 0.0F, 2.9671F));

		PartDefinition cube_r59 = left_arm.addOrReplaceChild("cube_r59", CubeListBuilder.create().texOffs(42, 50).mirror().addBox(-1.85F, -2.0F, 0.0F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.25F, 3.8933F, 1.8625F, 0.1745F, 0.0F, 0.0F));
