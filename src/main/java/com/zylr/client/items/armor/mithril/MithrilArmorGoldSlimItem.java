...
public class MithrilArmorGoldSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "mithril_armor_g");

    public MithrilArmorGoldSlimItem(ArmorType pType) {
