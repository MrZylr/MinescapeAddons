...
public class MetalArmorSlimModel extends ArmorModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(22, 57).mirror().addBox(-3.0F, 3.0F, 3.0F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		.texOffs(22, 57).addBox(-2.0F, 3.0F, 3.0F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 2.0F, 0.0F));
