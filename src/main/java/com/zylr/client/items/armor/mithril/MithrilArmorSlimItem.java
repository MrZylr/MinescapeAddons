...
public class MithrilArmorSlimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "mithril_armor");

    public MithrilArmorSlimItem(ArmorType pType) {
