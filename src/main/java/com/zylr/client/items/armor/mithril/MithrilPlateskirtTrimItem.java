...
public class MithrilPlateskirtTrimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "mithril_plateskirt_armor_t");

    public MithrilPlateskirtTrimItem(ArmorType pType) {
