...
public class DharoksArmorModel extends ArmorModel {

	public DharoksArmorModel(ModelPart root) {
        super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(50, 2).addBox(-2.5F, 3.75F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(1.0F))
		.texOffs(52, 57).addBox(-3.7076F, -3.8945F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(46, 31).addBox(-1.0107F, -2.7732F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(41, 16).addBox(-3.5F, -2.25F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		.texOffs(46, 31).addBox(-0.5F, -2.0F, -1.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3965F, -2.1991F, -2.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r4 = right_arm.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(46, 32).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.3787F, -1.5429F, -2.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r5 = right_arm.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(52, 57).addBox(-0.2328F, -0.8618F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.8223F, -1.0092F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r6 = right_arm.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(52, 57).addBox(-0.8853F, -0.8853F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.8223F, -1.0092F, 0.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r7 = right_arm.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(52, 57).addBox(-0.2328F, -0.1382F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.8223F, -1.0092F, 0.0F, 0.0F, 0.0F, 0.3927F));
		...
		.texOffs(52, 57).addBox(-0.363F, -0.3135F, -0.5927F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.8223F, -1.0092F, 0.0F, 0.0F, 0.2618F, 0.0F));
		...
		.texOffs(52, 57).addBox(-0.363F, -0.3135F, -0.4073F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.8223F, -1.0092F, 0.0F, 0.0F, -0.2618F, 0.0F));

		PartDefinition cube_r10 = right_arm.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(52, 57).addBox(-0.0312F, -0.7783F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9766F, -3.1635F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r11 = right_arm.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(52, 57).addBox(-0.0312F, -0.2217F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9766F, -3.1635F, 0.0F, 0.0F, 0.0F, 1.1781F));
		...
		.texOffs(52, 57).addBox(-0.1521F, -0.3135F, -0.5362F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9766F, -3.1635F, 0.0F, 0.0F, 0.2618F, 0.7854F));
		...
		.texOffs(52, 57).addBox(-0.1521F, -0.3135F, -0.4638F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9766F, -3.1635F, 0.0F, 0.0F, -0.2618F, 0.7854F));

		PartDefinition cube_r14 = right_arm.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(52, 57).addBox(-0.0312F, -0.7783F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2266F, -4.6635F, 0.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r15 = right_arm.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(52, 57).addBox(-0.731F, -0.731F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2266F, -4.6635F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r16 = right_arm.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(52, 57).addBox(-0.0312F, -0.2217F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2266F, -4.6635F, 0.0F, 0.0F, 0.0F, 1.5708F));
		...
		.texOffs(52, 57).addBox(-0.1521F, -0.3135F, -0.5362F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2266F, -4.6635F, 0.0F, 0.0F, 0.2618F, 1.1781F));
		...
		.texOffs(52, 57).addBox(-0.1521F, -0.3135F, -0.4638F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2266F, -4.6635F, 0.0F, 0.0F, -0.2618F, 1.1781F));

		PartDefinition cube_r19 = right_arm.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(52, 57).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.4033F, 3.9865F, 0.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r20 = right_arm.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(52, 57).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.75F, 4.423F, 0.0F, 0.0F, 0.0F, 0.3927F));
		...
		.texOffs(52, 57).addBox(-0.5F, -0.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.75F, 3.773F, -0.125F, 0.0F, 0.2618F, 0.0F));
		...
		PartDefinition cube_r23 = right_arm.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(52, 57).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5033F, 5.9865F, 0.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r24 = right_arm.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(52, 57).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.75F, 3.55F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(41, 16).mirror().addBox(-1.5F, -2.25F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(50, 2).mirror().addBox(-0.5F, 3.75F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(1.0F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition cube_r25 = left_arm.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(52, 57).mirror().addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5033F, 5.9865F, 0.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r26 = left_arm.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(52, 57).mirror().addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.4033F, 3.9865F, 0.0F, 0.0F, 0.0F, 0.7854F));
		...
		.texOffs(52, 57).mirror().addBox(-0.5F, -0.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.75F, 3.773F, 0.125F, 0.0F, 0.2618F, 0.0F));
		...
		.texOffs(52, 57).mirror().addBox(-0.5F, -0.9F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.75F, 4.173F, -0.125F, 0.0F, -0.2618F, 0.0F));

		PartDefinition cube_r29 = left_arm.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(52, 57).mirror().addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.75F, 4.423F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r30 = left_arm.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(52, 57).mirror().addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.75F, 3.55F, 0.0F, 0.0F, 0.0F, 0.3927F));
