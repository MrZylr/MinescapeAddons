...
public class MithrilPlateskirtItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "mithril_plateskirt_armor");

    public MithrilPlateskirtItem(ArmorType pType) {
