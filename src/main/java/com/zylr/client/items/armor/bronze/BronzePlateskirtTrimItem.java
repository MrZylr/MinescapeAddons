...
public class BronzePlateskirtTrimItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "bronze_plateskirt_armor_t");

    public BronzePlateskirtTrimItem(ArmorType pType) {
