...
public class AdamantPlateskirtItem extends AbstractArmorItem {
    private static final Identifier TEXTURE_LOCATION = makeCustomTextureLocation(MinescapeAddon.MOD_ID, "adamant_plateskirt_armor");

    public AdamantPlateskirtItem(ArmorType pType) {
