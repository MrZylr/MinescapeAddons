...
public class VeracsArmorSlimModel extends ArmorModel {

	public VeracsArmorSlimModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(0, 6).addBox(-1.5F, -2.4F, -2.975F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
		...
		.texOffs(34, 1).mirror().addBox(-0.5F, 1.6F, -1.475F, 2.0F, 3.0F, 3.0F, new CubeDeformation(1.0F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));
